...
\subsection{Saving flows}
alternativas a los flujos de guardado.

1. Hay que pulsar en guardar
2. Se guarda automaticamente

3. Hay que pulsar en guardar y además va detectando si los cambios realizados
alteran de alguna manera al objeto original para habilitar el botón de guardado o no.
Esto sobrecarga algo la interfaz pero aligera mucho el server ahorando algunas llamadas.
Esto también permite la cancelación de una modificación sin pérdida.
